      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex justify-between items-center h-20">
          <div className="flex items-center space-x-12">
            {/* Enhanced Logo */}
            <Link href={user ? "/studio" : "/"} className="flex items-center space-x-3 group">
          ...
          {/* User Section - Different for authenticated vs public */}
          <div className="flex items-center space-x-6">
            {user ? (
              ...
              <div className="flex items-center space-x-4">
                <div className="text-right">
                  <p className="text-body-sm text-[var(--muted-foreground)]">AI Fashion Studio</p>
                  <p className="text-caption text-[var(--foreground)] font-semibold">
