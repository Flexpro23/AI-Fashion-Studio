          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[var(--surface)] text-[var(--muted-foreground)]">or</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 border-2 border-[var(--primary)] rounded-xl text-[var(--primary)] hover:bg-[var(--primary)]/5 transition-colors"
              >
